...
import ViviNetworkDiagnostics from './modules/ViviNetworkDiagnostics';
...
export function getVivi() {
  ...
  registry.register(new ViviNetworkDiagnostics(bus));
...
// analytics: registry.get('analytics'),    security: registry.get('security'),
    ...
    networkDiagnostics: registry.get('network_diagnostics'),
