...
// Uses Firebase Storage for upload and Cloud Functions (via CoreIntegrations) for extraction.
    ...
    switch (action) {
      ...
      case 'extract': {
        ...
        const result = await CoreIntegrations.InvokeLLM({
          prompt: 'Extract the structured data from this file according to the provided schema.',
